local Library = {
  Open = true,
  Accent = Color3.fromRGB(90, 255, 142), -- Fresh mint green accent
  Pages = {},
  Sections = {},
  Flags = {},
  UnNamedFlags = 0,
  ThemeObjects = {},
  Instances = {},
  Keys = {}, -- Key mappings will be populated
  FontSize = 13,
  UIFont = Font.fromEnum(Enum.Font.Gotham), -- Modern Gotham font
}
...
do
  ...
  -- Add number keys
  for i = 0, 9 do
    keymap[Enum.KeyCode[tostring(i)]] = tostring(i)
    keymap[Enum.KeyCode["Keypad" .. tostring(i)]] = "Num" .. tostring(i)
  end

  -- Add special characters
  keymap[Enum.KeyCode.Minus] = "-"
  keymap[Enum.KeyCode.Equals] = "="
  keymap[Enum.KeyCode.Tilde] = "~"
  keymap[Enum.KeyCode.LeftBracket] = "["
  keymap[Enum.KeyCode.RightBracket] = "]"
  keymap[Enum.KeyCode.Quote] = "'"
  keymap[Enum.KeyCode.Comma] = ","
  keymap[Enum.KeyCode.Period] = "."
  keymap[Enum.KeyCode.Slash] = "/"
  keymap[Enum.KeyCode.BackSlash] = "\\"
  keymap[Enum.UserInputType.MouseButton1] = "MB1"
  keymap[Enum.UserInputType.MouseButton2] = "MB2"
  keymap[Enum.UserInputType.MouseButton3] = "MB3"
...
function Library:Window(config)
  ...
  main.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  function window:AddPage(name)
    ...
    tabButton.Position = UDim2.new(0, 0, 0, #self.Pages * 30)
    tabButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
    tabButton.BorderSizePixel = 0
    tabButton.Text = name
    tabButton.TextColor3 = Color3.fromRGB(200, 200, 200)
    tabButton.FontFace = Library.UIFont
    tabButton.TextSize = Library.FontSize

    -- Create page container
    local pageContainer = Instance.new("ScrollingFrame", contentArea)
    ...
    pageContainer.ScrollBarImageColor3 = Library.Accent
    pageContainer.Visible = #self.Pages == 0 -- Show first page by default

    -- Handle tab selection
    tabButton.MouseButton1Click:Connect(function()
      for _, p in pairs(self.Pages) do
        p.Container.Visible = false
        p.TabButton.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
      end
      pageContainer.Visible = true
      tabButton.BackgroundColor3 = Library.Accent
    end)
    ...
    function page:AddSection(name)
      ...
      sectionFrame.Position = UDim2.new(0, 0, 0, #self.Sections * 150)
      sectionFrame.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
      sectionFrame.BorderColor3 = Library.Accent
      ...
      sectionTitle.TextColor3 = Library.Accent
      ...
      function section:AddToggle(config)
        ...
        local toggleButton = Instance.new("TextButton", self.Container)
        toggleButton.Size = UDim2.new(1, -20, 0, 25)
        toggleButton.Position = UDim2.new(0, 10, 0, 35 + #self.Elements * 30)
        toggleButton.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        toggleButton.BorderColor3 = Library.Accent
        toggleButton.Text = toggle.Name
        toggleButton.TextColor3 = Color3.fromRGB(200, 200, 200)
        toggleButton.FontFace = Library.UIFont
        toggleButton.TextSize = Library.FontSize

        -- Create toggle indicator
        local indicator = Instance.new("Frame", toggleButton)
        indicator.Size = UDim2.new(0, 16, 0, 16)
        indicator.Position = UDim2.new(1, -21, 0.5, -8)
        indicator.BackgroundColor3 = toggle.State and Library.Accent or Color3.fromRGB(60, 60, 60)
        indicator.BorderColor3 = Library.Accent
      ...
      function section:AddSlider(config)
        ...
        sliderFrame.Position = UDim2.new(0, 10, 0, 35 + #self.Elements * 50)
        sliderFrame.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
        sliderFrame.BorderColor3 = Library.Accent
        ...
        local display = Instance.new("TextBox", sliderFrame)
        display.Size = UDim2.new(0, 50, 0, 25)
        display.Position = UDim2.new(1, -55, 0, 0)
        display.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
        display.BorderColor3 = Library.Accent
        display.Text = tostring(slider.Default)
        display.TextColor3 = Color3.fromRGB(200, 200, 200)
        display.FontFace = Library.UIFont
        display.TextSize = Library.FontSize
        ...
        sliderBar.BorderColor3 = Library.Accent
        ...
        display.FocusLost:Connect(function(enterPressed)
          if enterPressed then
            local value = tonumber(display.Text)
            if value then
...
--[[
  Original Code Integration Below
]]
...
function Library:Page(Options)
  ...
  Holder.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Holder.Text = ""
  ...
  Button.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Button.ZIndex = 53
  ...
  TopLine.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  TopLine.ZIndex = 53
  --
  Line.Name = "Line"
  Line.Position = UDim2.new(0,0,1,0)
  Line.Size = UDim2.new(1,0,0,1)
  Line.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Line.BorderSizePixel = 0
  Line.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Line.ZIndex = 53
  --
  Left.Name = "Left"
  ...
  Left.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Left.Rotation = -45
  Left.ZIndex = 53
  --
  RIght.Name = "RIght"
  ...
  RIght.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  RIght.Rotation = 45
  RIght.ZIndex = 53
  --
  Black.Name = "Black"
  ...
  Black.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Black.BorderSizePixel = 0
  Black.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Black.Rotation = -45
  Black.ZIndex = 55
  --
  Black2.Name = "Black2"
  ...
  Black2.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Black2.BorderSizePixel = 0
  Black2.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Black2.Rotation = 45
  Black2.ZIndex = 55
  --
  Title.Name = "Title"
  ...
  Title.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  PageSections.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  SectionHolder.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
...
function Library.Pages:Section(Options)
  ...
  Title.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Title.BackgroundTransparency = 1
  ...
  NewSection.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  NewSection.Visible = false
  --
  Left.Name = "Left"
  Left.Position = UDim2.new(0,2,0,0)
  Left.Size = UDim2.new(0.5,-10,1,0)
  Left.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Left.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  Bar.Name = "Bar"
  Bar.Size = UDim2.new(1,0,0,20)
  Bar.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Bar.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  Gradient.Name = "Gradient"
  Gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(
  ...
  GradientLine.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  LeftTitle.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  LeftTitle.Text = Section.LeftName
  LeftTitle.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  ...
  Right.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Right.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  Bar2.Name = "Bar2"
  Bar2.Size = UDim2.new(1,0,0,20)
  Bar2.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Bar2.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  ...
  GradientLine2.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  RightTitle.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  RightTitle.Text = Section.RightName
  RightTitle.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  ...
  LeftContent.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  RightConnect.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
...
function Library.Pages:Toggle(Options)
  ...
  Frame.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Frame.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  Accent.Name = "Accent"
  ...
  TextLabel.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  ...
  function Toggle:Keybind(Options)
    ...
    KeyHolder.Text = ""
    KeyHolder.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
    ...
    Value.Text = "[-]"
    Value.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:Slider(Options)
  ...
  if Slider.Name then
    ...
    Title.BackgroundColor3 = Color3.new(1,1,1)
    Title.BackgroundTransparency = 1
    Title.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
    Title.FontFace = Library.UIFont
    Title.TextSize = Library.FontSize
    Title.ZIndex = 105
    Title.TextXAlignment = Enum.TextXAlignment.Left
  ...
  plus.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  plus.Text = "+"
  plus.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  ...
  minus.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  minus.Text = "-"
  minus.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:List(Options)
  local Properties = Options or {};
  local Dropdown = {
    Window = self.Window,
    Page = self.Page,
  ...
  Icon.Text = "-"
  Icon.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  ...
  Content.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  Content.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  ...
  local function handleoptionclick(option, button, text)
    button.MouseButton1Click:Connect(function()
      for opt, tbl in next, Dropdown.OptionInsts do
        if opt ~= option then
          tbl.text.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
        end
      end
      Chosen = option
      Value.Text = option
  ...
  local function createoptions(tbl)
    for _, option in next, tbl do
      ...
      Option.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
      Option.Text = ""
      Option.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
      ...
      OptionName.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
      OptionName.Text = option
      OptionName.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:Multibox(Options)
  local Properties = Options or {};
  local Dropdown = {
    Window = self.Window,
    Page = self.Page,
    ...
    button.MouseButton1Click:Connect(function()
      if Dropdown.Max then
        if table.find(chosen, option) then
          ...
          text.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray

          Library.Flags[Dropdown.Flag] = chosen
          Dropdown.Callback(chosen)
        else
          if #chosen == Dropdown.Max then
            Dropdown.OptionInsts[chosen[1]].text.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:Keybind(Options)
  ...
  Holder.BackgroundTransparency = 1
  Holder.Text = ""
  Holder.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  Holder.AutoButtonColor = false
  Holder.Font = Enum.Font.SourceSans
  Holder.TextSize = 14
  --
...
function Library.Sections:Textbox(Options)
  ...
  TextFrame.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Dark background
  TextFrame.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  --
  Gradient.Name = "Gradient"
  Gradient.Color = ColorSequence.new{
    ColorSequenceKeypoint.new(
  ...
  TextBox.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  TextBox.Text = Textbox.State
  TextBox.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
  TextBox.FontFace = Library.UIFont
  TextBox.TextSize = Library.FontSize
  TextBox.PlaceholderText = Textbox.Placeholder
  TextBox.PlaceholderColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:Button(Options)
  ...
  Textbutton.BorderColor3 = Color3.fromRGB(45, 128, 71) -- Darker mint borders
  Textbutton.Text = Button.Name
  Textbutton.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
...
function Library.Sections:Colorpicker(Options)
  ...
  Color.Text = ""
  Color.TextColor3 = Color3.fromRGB(128,128,128) -- Light gray
